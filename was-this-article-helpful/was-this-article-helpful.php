...
* Plugin URI:
* Description: Get valuable qualitative feedback from your site visitors. Compatible with Google Analytics and Google Tag Manager.
* Version: 1.0
* Author: Hotbrain
* Author URI: https://hotbrain.ca
* License: GPL3
*/
/*
...
define("__HELPFUL_PLUGIN_NAME__", "Was This Article Helpful?");
